        ...
        return new Promise(async (resolve, reject) => {
          ...
          if(response.body == null) {
            ...
            if(!contentLength) {
              ...
              let loaded = 0; // received that many bytes at the moment
              ...
              const res = new Response(new ReadableStream({
                async start(controller) {
                  for (;;) {
                    ...
                    onDownloadProgress && onDownloadProgress({loaded, total});
    ...
    const downloadFile = (url) => {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (!contentLength || isNaN(contentLength)) {
                // If content length is not provided or not valid, handle accordingly
                console.warn("Content-Length header is missing or invalid.");
                ...
                resolve({
                    download_filename: "sample.mp3",
                    totalSize: blob.size // Use blob size as total size
                });
                return;
            }
